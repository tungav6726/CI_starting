...
<html lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo base_url(). "assets" ?> /img/apple-touch-icon-ipad-retina.png" />
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo base_url(). "assets" ?> /img/apple-touch-icon-iphone-retina.png" />
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo base_url(). "assets" ?> /img/apple-touch-icon-ipad.png" />
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo base_url(). "assets" ?> /img/apple-touch-icon-iphone.png" />
  ...
  <!-- ===========================
   ...
   =========================== -->
    ...
    <body data-spy="scroll">
       ...
       <header>               
        ...
        <div id="hero">           
            ...
            <img class="heroshot wow bounceInUp" data-wow-duration="4s" src="<?php echo base_url()."assets"?>/img/hero-img.png" alt="Featured Work">            
        </div><!--HERO AREA END-->        
    ...
    =========================== -->
     <div id="clients">
         <div class="container">
             ...
             <div class="col-md-9">
                 <ul><!--CLIENTS LOGO-->
                     <li><img src="<?php echo base_url(). "assets" ?> /img/payoneer.png" alt="Payoneer"></li>
                     <li><img src="<?php echo base_url(). "assets" ?> /img/amazon.png" alt="Amazon"></li>
                     <li><img src="<?php echo base_url(). "assets" ?> /img/elance-odesk.png" alt="Elance-oDesk"></li>
                     <li><img src="<?php echo base_url(). "assets" ?> /img/curb.png" alt="Curb Envy"></li>                     
                 </ul><!--CLIENTS LOGO END-->
             </div>
         </div>
         ...
         <div class="col-md-6">
            ...
            <div class="myapps row">
                ...
                <ul><!-- FAVORITE APP ICONS START -->
                    <li><img class="wow animated bounceInUp" data-wow-duration="1s" src="<?php echo base_url(). "assets" ?> /img/photoshop.svg" alt="Photoshop"></li>
                    <li><img class="wow bounceInUp" data-wow-duration="2s" src="<?php echo base_url(). "assets" ?> /img/illustrator.svg" alt="Illustrator"></li>
                    <li><img class="wow bounceInUp" data-wow-duration="3s" src="<?php echo base_url(). "assets" ?> /img/flash.svg" alt="Adobe Flash"></li>
                    <li><img class="wow animated bounceInUp" data-wow-duration="4s" src="<?php echo base_url(). "assets" ?> /img/after_effects.svg" alt="After Effects"></li>
                    <li><img class="wow bounceInUp" data-wow-duration="5s" src="<?php echo base_url(). "assets" ?> /img/indesign.svg" alt="InDesign"></li>
        ...
        <div class="row">
            ...
            <div class="col-md-6 wow bounceIn" data-wow-duration="2s">
                <div class="clientsphoto">
                    <img src="<?php echo base_url(). "assets" ?> /img/dan.jpg" alt="Dan">
                </div>
            ...
            <div class="col-md-6 wow bounceIn" data-wow-duration="3s">
                <div class="clientsphoto">
                    <img src="<?php echo base_url(). "assets" ?> /img/bill.jpg" alt="Bill">
                </div>
            ...
            <div class="col-md-6 wow bounceIn" data-wow-duration="3s">
                <div class="clientsphoto">
                    <img src="<?php echo base_url(). "assets" ?> /img/eric.png" alt="Eric">
                </div>
            ...
            <div class="col-md-6 wow bounceIn" data-wow-duration="2s">
                <div class="clientsphoto">
                    <img src="<?php echo base_url(). "assets" ?> /img/ramil.jpg" alt="Ramil">
                </div>
    ...
    <script src="<?php echo base_url(). "assets" ?> /js/jquery.jribbble-1.0.1.ugly.js"></script>
